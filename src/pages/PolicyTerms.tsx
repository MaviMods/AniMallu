...
const sections = [
  {
    ...
    content: (
      <Paragraph>
        ...
        for the functioning of AniMallu, such as account information and user
        preferences.
        <br></br>
        <br></br>
        ...
        <br></br>
        <br></br>
        <strong>Cookies and Tracking</strong>: AniMallu uses cookies and similar
  ...
  },
  {
    ...
    content: (
      <Paragraph>
        <strong>Acceptance of Terms</strong>: By using AniMallu, you agree to
        these Terms of Service and acknowledge that they affect your legal
        rights and obligations.
        <br></br>
        <br></br>
        <strong>Content</strong>: AniMallu does not host video content but embeds
        ...
        of the embedded videos remain with their respective owners. AniMallu
